    ...
    def configure_optimizers(self):
        ...
        optimizer = optim.Adam(
            [
                ...
                {"params": self.classifiers.parameters(), "lr": 1e-4},
...
def main(cfg: DictConfig):
    ...
    dummy_input_ids = torch.zeros((cfg.training.batch_size, cfg.model.max_length), dtype=torch.long)
    dummy_attention_mask = torch.ones((cfg.training.batch_size, cfg.model.max_length), dtype=torch.long)
